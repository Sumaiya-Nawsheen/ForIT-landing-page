...
<div className="row mt-5">
    ...
    <div className="col-lg-6 col-md-6 col-sm-16 mt-5">
  <div className="p-3 my-auto promoMargin" style={{display:'flex', alignItem:'center', justifyContent:'center'}}>
  <ClassToggleStyled>
    <div id="trigger" />
    <Controller>
...
{/* content */}
<div className="col-lg-6 col-md-6 col-sm-1 mt-lg-5 mt-sm-0">
 <div className="p-3 promoMargin" style={{textAlign:'left', fontFamily: 'Noto Serif JP, serif',color:'white'}}>
...
<div className="row mb-2 mt-2">
  <div className="col-lg-1 col-sm-1 my-auto"><img src={pin} alt=''/></div>
  <div className="col-lg-10 col-sm-10 my-auto"> <li> Slow-carb 90’s ennui Godard pug asymmetrical.</li></div>
</div>
